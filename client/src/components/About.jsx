    ...
    <>
      <div className="container my-5 py-5">
        ...
        It's not only writers who can benefit from this free
          ...
          random paragraph picker will be useful for your intended purposes is
          to give it a try. Generate a number of paragraphs to see if they are
          ...
          greatly beneficial for us to know the different ways this tool is
          ...
          you have the time, please send us a quick note on what you'd like to
          see changed or added to make it better in the future. F
        </div>
      </div>
    </>
  );
